...
class DeFlagPainter extends CustomPainter {
  const DeFlagPainter();
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint_0_fill.color = const Color(0xffffce00);
    ...
    Path path_2 = Path();
    path_2.moveTo(0, size.height * 0.3333333);
    ...
    paint_2_fill.color = const Color(0xffdd0000);
