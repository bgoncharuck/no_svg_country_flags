...
class CzFlagPainter extends CustomPainter {
const CzFlagPainter();
...
paint_1_fill.color = const Color(0xffd7141a);
canvas.drawPath(path_1,paint_1_fill);

Path path_2 = Path();
    path_2.moveTo(size.width*0.5625000,size.height*0.5000000);
    path_2.lineTo(0,0);
    path_2.lineTo(0,size.height);
    path_2.close();

Paint paint_2_fill = Paint()..style=PaintingStyle.fill;
paint_2_fill.color = const Color(0xff11457e);
