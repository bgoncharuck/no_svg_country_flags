...
class GaFlagPainter extends CustomPainter {
const GaFlagPainter();
...
Path path_1 = Path();
    path_1.moveTo(size.width,size.height*0.3333333);
...
paint_1_fill.color = const Color(0xff36a100);
...
paint_2_fill.color = const Color(0xff006dbc);
