...
class CmFlagPainter extends CustomPainter {
const CmFlagPainter();
...
paint_0_fill.color = const Color(0xff007a5e);
...
Path path_3 = Path();
    path_3.moveTo(0,size.height*-0.01666667);
    path_3.lineTo(size.width*-0.003906250,size.height*-0.0008333333);
    path_3.lineTo(size.width*0.002031250,size.height*0.001875000);
    path_3.close();
