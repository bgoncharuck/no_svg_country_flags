...
class BwFlagPainter extends CustomPainter {
const BwFlagPainter();
...
paint_0_fill.color = const Color(0xff00cbff);
...
Path path_2 = Path();
    path_2.moveTo(0,size.height*0.3875000);
    path_2.lineTo(size.width,size.height*0.3875000);
    path_2.lineTo(size.width,size.height*0.6125000);
    path_2.lineTo(0,size.height*0.6125000);
    path_2.close();
