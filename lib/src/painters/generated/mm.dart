...
class MmFlagPainter extends CustomPainter {
const MmFlagPainter();
...
paint_0_fill.color = const Color(0xfffecb00);
...
paint_1_fill.color = const Color(0xff34b233);
...
paint_2_fill.color = const Color(0xffea2839);
canvas.drawPath(path_2,paint_2_fill);

Path path_3 = Path();
    path_3.moveTo(0,size.height*-0.002083333);
    path_3.lineTo(size.width*0.0004687500,0);
    path_3.lineTo(size.width*-0.0004687500,0);
    path_3.close();
