...
class MgFlagPainter extends CustomPainter {
const MgFlagPainter();
...
Path path_0 = Path();
    path_0.moveTo(size.width*0.3332813,0);
    path_0.lineTo(size.width,0);
    path_0.lineTo(size.width,size.height*0.5000000);
    path_0.lineTo(size.width*0.3332813,size.height*0.5000000);
    path_0.close();

Paint paint_0_fill = Paint()..style=PaintingStyle.fill;
paint_0_fill.color = const Color(0xfffc3d32);
canvas.drawPath(path_0,paint_0_fill);

Path path_1 = Path();
    path_1.moveTo(size.width*0.3332813,size.height*0.5000000);
