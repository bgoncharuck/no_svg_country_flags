...
class AeFlagPainter extends CustomPainter {
const AeFlagPainter();
...
paint_0_fill.color = const Color(0xff00732f);
...
Path path_3 = Path();
    path_3.moveTo(0,0);
    path_3.lineTo(size.width*0.3437500,0);
    path_3.lineTo(size.width*0.3437500,size.height);
