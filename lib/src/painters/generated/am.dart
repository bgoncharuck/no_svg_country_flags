...
class AmFlagPainter extends CustomPainter {
const AmFlagPainter();
...
paint_0_fill.color = const Color(0xffd90012);
...
paint_1_fill.color = const Color(0xff0033a0);
...
paint_2_fill.color = const Color(0xfff2a800);
