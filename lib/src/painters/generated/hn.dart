...
class HnFlagPainter extends CustomPainter {
const HnFlagPainter();
...
paint_0_fill.color = const Color(0xff18c3df);
...
Path path_2 = Path();
    path_2.moveTo(size.width*-0.0004687500,0);
    path_2.lineTo(size.width*0.0003125000,size.height*0.0002083333);
    path_2.lineTo(0,size.height*-0.002083333);
    path_2.close();
